...
class TurnTableRender(nn.Module):
    def __init__(
        ...
        self.pose_list = load_amass_smpl_poses(self.amass_dir, num_poses=100)
    ...
    def forward(self, uv_img_path, gif_name="render", n_frames=30, duration=50):
        ...
        p = random.sample(self.pose_list, k=1)[0]
        gdim, pdim, bdim = (
        ...
        gif_path = f"{self.render_out_dir}/{gif_name}.gif"
        frames[0].save(
            gif_path,
            save_all=True,
...
if __name__ == "__main__":
    ...
    uv_path = os.path.abspath("../texdreamer/tex4.png")
    frames = renderer(uv_path, gif_name="render4", n_frames=60)
